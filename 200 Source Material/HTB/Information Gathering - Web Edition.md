...
[[#DNSEnum|Within the zone record transferred above, find the ip address for ftp.admin.inlanefreight.htb.]] [(Link)](https://academy.hackthebox.com/module/144/section/1255)

[[#Relevant section|Within the same zone record, identify the largest IP address allocated within the 10.10.200 IP range.]] [(Link)](https://academy.hackthebox.com/module/144/section/1255)

[[#Relevant section|Exercise question.]] [(Link)](https://example.com)
...
[[#Relevant section|Exercise question.]] [(Link)](https://example.com)
##### Questions:
[[#Utilising WHOIS|Perform a WHOIS lookup against the paypal.com domain. What is the registrar Internet Assigned Numbers Authority (IANA) ID number?]] A: <span class="hover-reveal">292</span>

[[#Utilising WHOIS|What is the admin email contact for the tesla.com domain (also in-scope for the Tesla bug bounty program)?]] A: <span class="hover-reveal">admin@dnstinations.com</span>

[[#The Domain Information Groper|Which IP address maps to inlanefreight.com?]] A: <span class="hover-reveal">134.209.24.248</span>

[[#The Domain Information Groper|hat is the full domain returned when you query the mail records for facebook.com]] A: <span class="hover-reveal">smtpin.vvv.facebook.com</span>

[[#DNSEnum]Using the known subdomains for inlanefreight.com (www, ns1, ns2, ns3, blog, support, customer), find any missing subdomains by brute-forcing possible domain names.] A: <span class="hover-reveal">my.inlanefreight.com</span>
